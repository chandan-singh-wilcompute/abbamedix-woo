...
function patient_registration_action($record, $handler) {
    ...
    ample_connect_log("patient data : ");
    ample_connect_log($patient_data);

    ample_connect_log("Ample client response - ");
    ample_connect_log($ample_client_response);
    ...
    ample_connect_log($update_response);
