...
<div class="fc-contact-login">
	...
	<?php if ( !is_user_logged_in()){ ?>
		<a href="<?php echo esc_url(site_url('/registration')); ?>" type="button" class="button register" style="width: 100%;">Register</a>
	<?php } ?>
