...
class FluidCheckout_Steps extends FluidCheckout {
	...
	public function output_expansible_form_section_start_tag( $section_id, $toggle_label, $args = array() ) {
		...
		$discount_text = "
			<h4>Discounts/Policies</h4>
			<button type='button' class='coupon-button btn btn-light' data-coupon-code='EMP20' data-coupon-id='".$section_id_esc."'>Dried Employee Discount: 20%</button>
			<button type='button' class='coupon-button btn btn-outline-light' data-coupon-code='EMP15' data-coupon-id='".$section_id_esc."'>Other Employee Discount: 15%</button>
			<p></p>
			<p class='discount-info'>- Dried Employee Discount is applicable only to (Dried Flower / Pre-rolls)</p>
			<p class='discount-info'>- Other Employee Disccount is applicable to all products except Dried Flowew, Pre-rolls, Accessories & Inhaler</p>
			";
		...
		<?php 
		// if($toggle_label == "Add coupon code"){
		// 			echo $discount_text;
		// 		} 
		?>
