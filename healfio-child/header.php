          ...
          <label>QUICK TOUR</label>
					<div class="header-screen">
						...
						<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
						 width="25px" height="19px" viewBox="0 0 1280.000000 972.000000"
					...
					<div class="header-call">
						<a class="menu-item " href="<?php bloginfo('url'); ?>/contact-us"><svg width="22px" height="22px" viewBox="0 0 28 28" version="1.1" 
    ...
    <div class="colGroup">
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Flower']) ? $categories['Flower'] : [];
              foreach($sc as $s):
          ?>
        ...
        <div class="labelGroup">
          <h5>Vapes</h5>
          <?php 
              $sc = isset($categories['Vapes']) ? $categories['Vapes'] : [];
              foreach($sc as $s):
          ?>
      ...
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Concentrates']) ? $categories['Concentrates'] : [];
              foreach($sc as $s):
          ?>
      ...
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Edibles']) ? $categories['Edibles'] : [];
              foreach($sc as $s):
          ?>
      ...
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Extracts']) ? $categories['Extracts'] : [];
              foreach($sc as $s):
          ?>
      ...
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Beverages']) ? $categories['Beverages'] : [];
              foreach($sc as $s):
          ?>
      ...
      <div class="col">
        ...
        <div class="labelGroup">
          <?php 
              $sc = isset($categories['Topicals']) ? $categories['Topicals'] : [];
              foreach($sc as $s):
          ?>
